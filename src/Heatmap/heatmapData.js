...
// export const heatmapData = [
//   { y: 'Americano', x: 'Calories', value: 3 },
//   { y: 'Americano', x: 'Cholesterol (mg)', value: 1 },
//   { y: 'Americano', x: 'Sugar (g)', value: 0 },
//   { y: 'Americano', x: 'Carbs (g)', value: 5 },
//   { y: 'Americano', x: 'Caffeine (mg)', value: 175 },
//   { y: 'Latte', x: 'Calories', value: 70 },
//   { y: 'Latte', x: 'Cholesterol (mg)', value: 10 },
//   { y: 'Latte', x: 'Sugar (g)', value: 9 },
//   { y: 'Latte', x: 'Carbs (g)', value: 75 },
//   { y: 'Latte', x: 'Caffeine (mg)', value: 75 },
//   { y: 'Mocha', x: 'Calories', value: 110 },
//   { y: 'Mocha', x: 'Cholesterol (mg)', value: 21 },
//   { y: 'Mocha', x: 'Sugar (g)', value: 17 },
//   { y: 'Mocha', x: 'Carbs (g)', value: 60 },
//   { y: 'Mocha', x: 'Caffeine (mg)', value: 85 },
//   { y: 'Macchiato', x: 'Calories', value: 100 },
//   { y: 'Macchiato', x: 'Cholesterol (mg)', value: 17 },
//   { y: 'Macchiato', x: 'Sugar (g)', value: 15 },
//   { y: 'Macchiato', x: 'Carbs (g)', value: 70 },  
//   { y: 'Macchiato', x: 'Caffeine (mg)', value: 75 },  
//   { y: 'Cappuccino', x: 'Calories', value: 50 },
//   { y: 'Cappuccino', x: 'Cholesterol (mg)', value: 8 },
//   { y: 'Cappuccino', x: 'Sugar (g)', value: 7 },
//   { y: 'Cappuccino', x: 'Carbs (g)', value: 60 },
//   { y: 'Cappuccino', x: 'Caffeine (mg)', value: 75 },
// ];
